...
helping = 'help - показывает все возможные команды\npwd - показывает название рабочей директории\nls - показывает ' \
          'содержимое текущей директории\ncd <path> - перемещение по директориям\nmkdir <dirname> - создать ' \
          'директорию (рекурсивно)\nrmtree <dirname> - удалить директорию (рекурсивно)\ntouch <filename> - создать ' \
          'пустой файл\nremove <filename> - удалить файл\ncat <filename> - отправляет содержимое файла\nsend_file ' \
          '<filename> - отправляет файл в текущую директорию у клиента\nget_file <filename> - принимает файл с ' \
          'текущей директории клиента\nexit - отключение клиента от сервера '
